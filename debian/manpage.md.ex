% vala-language-server(SECTION) | User Commands
%
% "February  3 2024"
...
vala-language-server - program to do something

# SYNOPSIS

**vala-language-server** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**vala-language-server** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **vala-language-server** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**vala-language-server** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    vala-language-server. See **foo.conf**(5) for further details.
...
**vala-language-server** provides some return codes, that can be used in scripts:
...
Alan Knowles <alan@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Alan Knowles
